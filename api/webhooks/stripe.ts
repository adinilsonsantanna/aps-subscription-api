...
// Handler serverless para webhook do Stripe (funciona na Vercel!)
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    // A Vercel pode entregar o body como Buffer, string ou objeto JSON
    let payload: string;
    ...
    if (Buffer.isBuffer(req.body)) {
      ...
      // Se já foi parseado como objeto JSON, reconverte para string
